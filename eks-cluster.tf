resource "aws_eks_cluster" "tf_test_cluster" {
...
data "tls_certificate" "cert" {
  url = aws_eks_cluster.tf_test_cluster.identity[0].oidc[0].issuer
}
...
resource "aws_security_group_rule" "cluster_inbound" {
  ...
  from_port                = 0
  protocol                 = "-1"
  security_group_id        = aws_eks_cluster.tf_test_cluster.vpc_config[0].cluster_security_group_id
